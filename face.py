...
def recognize():
    ...
    arshad_image = face_recognition.load_image_file("photos/arshad.jpg")
    arshad_encoding = face_recognition.face_encodings(arshad_image)[0]

    binod_image = face_recognition.load_image_file("photos/binod.jpg")
    ...
    nirmal_image = face_recognition.load_image_file("photos/nirmal.png")
    nirmal_encoding = face_recognition.face_encodings(nirmal_image)[0]

    rashika_image = face_recognition.load_image_file("photos/rashika.jpg")
    ...
    shashi_image = face_recognition.load_image_file("photos/shashi.jpg")
    ...
    frame = cv2.imread('detected_frame.jpg')
